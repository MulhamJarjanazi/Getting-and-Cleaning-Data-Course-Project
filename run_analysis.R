...
##choosing the columns for mean and std
...
##collecting data from all the required text files
...
##changing the values for $Activity from numbers to descriptive terms
...
##combining all columns to one big dataset that is returned
